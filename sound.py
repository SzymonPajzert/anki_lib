...
import  random
from anki_lib.hooks import addHook, runHook
from anki_lib.utils import  tmpdir, isWin, isMac, isLin
...
from anki_lib.mpv import MPV, MPVBase
...
# if anki_lib.crashes, an old mplayer instance may be left lying around,
...
def cleanupOldMplayerProcesses():
    ...
    for proc in psutil.process_iter():
        try:
            ...
            # not anki_lib.s bundled mplayer
