...
from anki_lib.stdmodels import addBasicModel
from anki_lib.importing.noteimp import NoteImporter, ForeignNote, ForeignCard
from anki_lib.lang import _
from anki_lib.lang import ngettext
...
#file = u'/home/epcim/hg2g/dev/python/sm2anki_lib.ADVENG2EXP.xxe.esc.zaloha_FINAL.xml'
#file = u'/home/epcim/hg2g/dev/python/anki_lib.libanki_lib.tests/importing/supermemo/original_ENGLISHFORBEGGINERS_noOEM.xml'
#file = u'/home/epcim/hg2g/dev/python/anki_lib.libanki_lib.tests/importing/supermemo/original_ENGLISHFORBEGGINERS_oem_1250.xml'
#file = str(sys.argv[1])
