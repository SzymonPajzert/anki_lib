...
from anki_lib.utils import intTime, splitFields, joinFields
from anki_lib.importing.base import Importer
...
class Anki2Importer(Importer):
    ...
    def _prepareFiles(self):
        importingV2 = self.file.endswith(".anki_lib.1")
...
insert or ignore into revlog values (?,?,?,?,?,?,?,?,?)""", revlog)
    ...
    # note: this func only applies to imports of .anki_lib.. for .apkg files, the
